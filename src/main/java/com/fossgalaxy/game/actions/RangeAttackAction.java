...
public class RangeAttackAction extends AbstractAction {
    ...
    public int getRange(Entity actor) {
        return actor.getType().getProperty("attackRange", 0);
    }
    ...
    public Order generateOrder(CubeCoordinate co, GameState s) {
        ...
        return new AttackOrderRanged(e);
    }
    ...
    public boolean isPossible(Entity entity, GameState s, CubeCoordinate co) {
        ...
        int movementDist = entity.getType().getProperty("attackRange", 0);
    ...
    public boolean isPossible(Entity entity, GameState s) {
        return entity.getType().getProperty("attackRange", 0) >= 1;
    }
    ...
    public String getCategory() {
        return com.fossgalaxy.games.tbs.actions.AbstractAction.CAT_ATTACK;
    }
}
